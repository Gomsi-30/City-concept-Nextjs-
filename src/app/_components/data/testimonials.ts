...
export const testimonials = [
    {
       ...
       title: `"Cityconcept made my house-hunting experience so much easier! The platform’s user-friendly interface helped me find the perfect flat in New York within days. I would definitely recommend it to anyone looking for a stress-free property search!"
'`
    },
    {
